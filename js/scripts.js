window.onload = function(){
	...
	function startScreen() {
		document.getElementById("pic").setAttribute("src", "img/banner.jpg");
//		document.getElementById("ua_var").innerHTML = "Бажаєш отримати знижку за ерудицію?";
	...
	function trueOrFalse(event){
			if (event.target.getAttribute("alt")){
				...
				document.getElementById("audio").innerHTML = "<audio src='win.mp3' autoplay></audio>";
			} else {
				...
				document.getElementById("audio").innerHTML = "<audio src='lost.mp3' autoplay></audio>";
			};
			seeYou();
